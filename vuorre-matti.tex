...
\sectionfont{\rmfamily\mdseries\upshape\Large\addfontfeature{Color = draculaorange}}
\subsectionfont{\rmfamily\bfseries\upshape\normalsize\addfontfeature{Color = draculayellow}} 
...
\hypersetup{linkcolor=draculapurple,citecolor=draculapurple,filecolor=black,urlcolor=draculapurple} 
\urlstyle{same}

% Content
\begin{document}
\noindent{\LARGE\color{draculapink} Matti Vuorre}\\[4pt]
{\Large\color{draculagreen} >> Curriculum vitae}
\vspace{24pt}
...
\aiCV \ \today \ [\href{https://github.com/mvuorre/CV/dracula/main/vuorre-matti.pdf}{latest}]
\end{multicols}
...
For the most up-to-date info, see \href{https://www.zotero.org/vuorre}{\aiZotero otero} or \href{https://scholar.google.com/citations?hl=en&user=I4DSy-8AAAAJ&view_op=list_works&sortby=pubdate}{\aiGoogleScholar oogle Scholar}.
...
\item Johannes, N., Vuorre, M., Magnusson, K., \& Przybylski, A. K. (2022). Time spent playing two online shooters has no measurable effect on aggressive affect. \emph{PsyArXiv}. \url{https://doi.org/10.31234/osf.io/gt8ze}
...
\item Vuorre, M., Johannes, N., Magnusson, K., \& Przybylski, A. K. (2021). Time spent playing video games is unlikely to impact well-being. \emph{PsyArXiv}. \url{https://doi.org/10.31234/osf.io/8cxyh}
