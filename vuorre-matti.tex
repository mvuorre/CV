...
5037 DB Tilburg\\
The Netherlands\\
\faIcon[regular]{envelope} \href{mailto:m.j.vuorre@tilburguniversity.edu}{m.j.vuorre@tilburguniversity.edu}\\
\vfill\null
\columnbreak
...
I am a psychological scientist at the Tilburg School for Social and Behavioral Sciences at Tilburg University, where I study how digital environments relate to psychological well-being and cognition using experimental, data science, and statistical methods. 
...
\begin{itemize}
  \item Vuorre, M., Magnusson, K., Johannes, N., Butlin, J., \& Przybylski, A. K. (2023). An intensive longitudinal dataset of video game play, well-being, and motivations: Case study of PowerWash Simulator. \emph{PsyArXiv}. \url{https://doi.org/10.31234/osf.io/kyn7g}
  \item Zloteanu, M., \& Vuorre, M. (2023). Bayesian Generalized Linear Mixed Effects Models for Deception Detection Analyses. \emph{PsyArXiv}. \url{https://doi.org/10.31234/osf.io/fdh5b}
...
\subsection*{Talks}
\begin{itemize}
  \item \years{2023} Intensive longitudinal dataset of video game play, well-being, and motivations: Case study of PowerWash Simulator. \emph{International Convention of Psychological Science, Brussels}
  \item Frontiers in Video Game Science. \emph{Symposium organizer; International Convention of Psychological Science, Brussels}
